...
seu.obj.pbmc <- readRDS(file = "/pl/active/dow_lab/dylan/k9_PBMC_scRNA/analysis/output/s3/220926_cfam_hVoWadj_res1.2_dims45_S3.rds")
...
### Fig 1a: create raw UMAP of tumor cells used in analysis
...
### Fig 1a: create raw UMAP of pbmcs used in analysis
